...
class TrainClassifier(FlowSpec):
  ...
  def init_system(self):
    ...
    #I commented this code because MetaFlow fails when it's part of the class
    #instead I recreate it from scratch in train and test methods
    ...
    self.dm = dm
    self.config = config
    #self.system = system # see comment above
